...
function getData(){
    ...
    .then(function (response) {
        ...
        (response.data.products).forEach((item) => {
            template += `
            <div class="single-hero-slider-7" onclick="location.href='`+baseUrl+`/jewel/`+item.id+`'">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-content-wrap">
                                ...
                                <div class="inner-images">
                                    <div class="image-one">
                                        <img src="`+item.image+`.png" width="250" class="img-fluid" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>
