                ...
                <div class="col-lg-12 d-none d-md-block">
                    <div class="top-logo-area">
                        <div class="logo text-md-center">
                            <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/logo.jpg')}}" alt="logo" style="width:40%"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-lg-3 col-6">
                    ...
                    <div class="logo__hidden text-start">
                        <a href="{{route('home')}}"><img src="{{asset('assets/images/logo/logo.jpg')}}" alt="" style="height:40px"></a>
                    </div>
                </div>
